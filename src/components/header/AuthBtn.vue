<template>
  <div class="auth-btn">
    <a-button-group>
      <a-button @click="injectHandle.openAuthModal('login')">登录</a-button>
      <a-button @click="injectHandle.openAuthModal('reg')">注册</a-button>
    </a-button-group>
    ...
    >
      ...
      <div>
        ...
        <a-button class="w-full my-2" html-type="submit" type="primary" size="large" @click="regSubmit">注册</a-button>
...
// const { openAuthModal } = inject('authModal');
