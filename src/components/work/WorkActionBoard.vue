<template>
  <div ref="actionBoardRef" class="work-action-board fixed top-[240px] z-[100]">
    <div
    ...
    >
      ...
      <a-button v-if="!showFollowBtn" class="absolute bottom-[8px]" size="mini" type="primary" @click="followAction"
        >关注</a-button
      >
    </div>
