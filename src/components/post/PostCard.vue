<template>
  ...
  >
    <div v-if="post.cover" class="left cover rounded-md">
      <img :src="post.cover" class="cover rounded-md" />
    </div>
    <div class="right flex flex-col items-start justify-between w-[100%]" :class="[post.cover ? 'ml-5 ' : '']">
      ...
      <div class="meta flex flex-row flex-nowrap items-center justify-between w-full">
        <div class="meta-left leading-7 text-xs">
              ...
              >
                ...
                <div class="flex flex-row justify-around items-center mb-[5px]">
                  ...
                  <div class="flex flex-col items-center justify-center">
                    ...
                    <span class="text-sm text-gray-500 font-bold mt-[10px]">文章</span>
                  </div>
                </div>
              </div>
            </template>
          ...
          <span v-if="showSubject" class="text-gray-400">{{ post.subject.title }}-{{ post.plates[0].name }}</span>
          <a-divider direction="vertical" />
            ...
            >
              ...
              <template #content>
                <div class="demo-basic w-full">
                  <span
                    class="block text-sm hover:bg-gray-100 w-full p-2 flex flex-row flex-nowrap items-center justify-start"
