      ...
      <div class="content-left w-[560px]">
        ...
        <div class="calender-box mt-[20px] w-[560px]">
          ...
          <div class="dates">
            ...
            <div class="date flex flex-row flex-wrap w-full">
              <template v-for="date in calenderList" :key="date">
                <div
                  ...
                  :class="[
                    date.week % 7 === 1 ? 'ml-0 mr-[6px]' : date.week % 7 === 0 ? 'mr-0 ml-[6px]' : 'mx-[6px]',
                ...
                <div
                  ...
                  :class="[date.week % 7 === 1 ? 'ml-0 mr-[6px]' : date.week % 7 === 0 ? 'mr-0 ml-[6px]' : 'mx-[6px]']"
                ></div>
              </template>
            </div>
          </div>
      ...
      <div class="content-right w-[280px] mx-auto">
        ...
        >
          ...
          <span v-if="!signinStatus" class="text-xs flex flex-row justify-center items-center w-full">
            <span class="mx-[5px]">黑火能量 +10</span>
            ...
            <a-card-meta>
              ...
              <template #description>
                <div class="flex flex-col">
                  <span class="left text-sm leading-[26px]">{{ signinLine.content }}</span>
...
import { calendar } from '@/utils/format';
