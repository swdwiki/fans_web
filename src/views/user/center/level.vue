    ...
    <div>
      <div class="head h-[60px] flex flex-row justify-between items-center px-[20px] bg-white">
        ...
        <div>
          ...
          <!-- <span class="text-gray-500">经验明细</span> -->
        </div>
      </div>
      <a-divider margin="0" />
      <div class="bg-white">
        <div v-if="myLevel" class="level-card p-[10px]">
          ...
          >
            ...
            <!-- </a-col>
              <a-col :flex="1"> -->
            <a-statistic extra="当前经验值" :value="myLevel.exp" show-group-separator> </a-statistic>
            <!-- </a-col>
              <a-col :flex="1"> -->
            <a-statistic
              extra="距离下一次升级还有"
    ...
    <div class="mt-[20px]">
      ...
      <div class="flex flex-row flex-wrap bg-white items-center">
        <div
          ...
          :key="index"
          class="task-card w-[280px] border border-gray-200 rounded-md m-[15px] flex flex-row flex-nowrap justify-between items-center py-[5px] px-[10px]"
        >
