<template>
  <div class="w-[1200px] mx-auto flex flex-row justify-center mb-[100px]">
          ...
          <div class="card_handle">
            <div v-if="stick.author.userId !== userInfo.userId">
              <a-button
                ...
                size="large"
                type="primary"
                @click="follow(stick.author.userId)"
                >关注</a-button
              >
              <a-popconfirm v-else content="确定取消关注么？" @ok="follow(stick.author.userId)">
                <a-button
                  class="w-full"
                  size="large"
  ...
  stickApi
    ...
    .then((res) => {
      if (res.code === 0) {
        ...
        console.log(comments.value[commentIndex].replys);
