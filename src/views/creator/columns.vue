              ...
              <a-card-meta>
                <template #title>
                  <div class="flex flex-row flex-nowrap justify-between items-center">
                    ...
                    <div>
                      <span class="text-base">{{ column.name }}</span>
                      <!-- <span class="text-xs text-gray-400 ml-2">{{ column.posts.length }}篇文章</span> -->
                    </div>
                    <div>
                      <a-trigger position="bottom" trigger="click" auto-fit-position :unmount-on-close="false">
                        ...
                        <template #content>
                          <div class="demo-basic flex flex-col justify-center items-center">
                            <!-- <a-empty /> -->
                            <!-- <span class="block leading-9 hover:bg-gray-100 w-full text-center">管理文章</span> -->
                            <span
                ...
                <template #description>
                  <span class="text-xs text-gray-400">{{ column.posts?.length }}篇文章</span>
                  <div class="h-8">
